...
public class AddCircleDialog1 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			AddCircleDialog1 dialog = new AddCircleDialog1();
	 ...
	 * Create the dialog.
	 */
	public AddCircleDialog1() {
		setDefaultCloseOperation(JDialog.DO_NOTHING_ON_CLOSE);
		setBounds(100, 100, 450, 300);
		getContentPane().setLayout(new BorderLayout());
		contentPanel.setBorder(new LineBorder(new Color(0, 0, 0), 4));
	...
	public Circle showDialogy(Circle o) throws Exception 
	{
		if(o != null) 
		{
